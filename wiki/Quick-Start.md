# â¡ Architect AI â Quick Start (5 Minutes)
...
- ð Docs: See `ARCHITECT_AI_README.md`
- ðï¸ Integration: See `INTEGRATION_GUIDE.md`
- ð Deployment: See `DEPLOYMENT_GUIDE.md`
