...
const MODULE_CONFIG = [
  ...
  { id: "mobile",     icon: "◻", label: "Mobile Security Layer",        vector: "V-04", to: "/dashboard/system"     },
  { id: "deepweb",    icon: "◉", label: "Deep Web Exposure",            vector: "V-05", to: "/dashboard/deepweb"    },
  { id: "broker",     icon: "⧫", label: "Data Broker Removal",          vector: "V-06", to: "/dashboard/databroker" },
  ...
  { id: "medical",    icon: "⊕", label: "Medical Data Footprint",       vector: "V-10", to: "/dashboard/medical"    },
  { id: "biometric",  icon: "⊛", label: "Voice & Biometric Data",       vector: "V-11", to: "/dashboard/biometric"  },
  { id: "iot",        icon: "⊡", label: "IoT & Smart Device Scan",      vector: "V-12", to: "/dashboard/iot"        },
  { id: "cloud",      icon: "⊞", label: "Cloud Storage Exposure",       vector: "V-13", to: "/dashboard/cloud"      },
  { id: "darkweb",    icon: "◈", label: "Dark Web Monitoring",          vector: "V-14", to: "/dashboard/darkweb"    },
  { id: "behavioral", icon: "⊟", label: "Behavioral Profile Analysis",  vector: "V-15", to: "/dashboard/behavioral" },
