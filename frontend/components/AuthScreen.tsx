      ...
      <GlassCard className="w-[480px] p-12 text-center" style={{ animation: "slide-in-up 0.6s ease" }}>
        ...
        {step === "landing" && !scanning && (
          <div style={{ animation: "fade-in 0.4s ease" }}>
            ...
            <div className="rounded-lg border px-4 py-3 mb-5 text-left" style={{ background: "rgba(0,212,255,0.05)", borderColor: "rgba(0,212,255,0.12)" }}>
              ...
              <div className="text-[0.72rem] leading-relaxed mt-1" style={{ color: NEON.textMuted }}>
                Analysis stays ephemeral by default. We only save profile data or monitored emails after explicit user consent.
              </div>
            </div>
