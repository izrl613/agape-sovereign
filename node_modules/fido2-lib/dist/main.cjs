...
function coerceToArrayBuffer$1(buf, name) {
	...
	if (typeof buf === "string" && buf === "") {
		...
		// base64 to Buffer
		buf = base64.base64.toArrayBuffer(buf, true);
	}
...
function coerceToBase64(thing, name) {
	...
	if (typeof thing !== "string") {
		try {
			thing = base64.base64.fromArrayBuffer(
...
function jsObjectToB64(obj) {
	return base64.base64.fromString(
...
class MdsCollection {
	...
	findEntry(id) {
		...
		return this.entryList.get(id.replace(/-/g, "")) ||
			this.entryList.get(
				abToHex(base64.base64.toArrayBuffer(id, true)).replace(/-/g, ""),
			) || null;
	}
}
...
async function androidSafetyNetValidateFn() {
	...
	const nonce = base64.base64.fromArrayBuffer(hash);
