...
// access to these sensitive values can be controlled. defineSecret does
// this for you automatically. If you are using Google Developer API
// (googleAI) you can get an API key at:
